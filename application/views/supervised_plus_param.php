...
<html>
    <head>
        <title>Flash Card Game - Supervised plus Mode Parameters</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="logOut">
					...
					if ($this->ion_auth->logged_in()) {
						...
						echo anchor('game/logout', 'LOGOUT');
					}
					?>
                </div>
            </div>
            ...
            <div class="rmParamFormHolder">
				...
				?>
                <form method="POST" action="<?php echo base_url() ?>index.php/game/supervised_plus_param" id="rmParamForm">
                    <table>
                        <tr>
                            <td>
