...
<html>
    <head>
        ...
        <script type="text/javascript">
			...
			function loadDecks() {
				loadGame(92)
<?php /* ?>var loadDecksAjaxPath = "<?php echo base_url()?>" + "index.php/game/load_decks/" + "<?php echo $this->ion_auth->user()->row()->id ?>";<?php */ ?>
    ...
    <body onLoad="startGame()">
        <div class="container">
            ...
            <div class="gameModeScreen" id="gameModeScreen">
                ...
                <div class="buttonHolder"><div class="buttonInner"><div class="button green" onClick="javascript:setGameModeAndLoadDecks('RW')"><p>Quick Review</p></div></div></div> 
                <br/><br/><br/>
