...
class Ion_auth_model extends CI_Model {
    ...
    public function update($id, array $data) {
        ...
        //print_r($this->user($id)->row());
        $user = $this->user($id)->row();
        //print_r($this->user($id)->row()); not show deck value
        //print_r($data); show deck value
        //die();
        $this->db->trans_begin();
     ...
     * @author aditya menon
     */
    public function create_group($group_name = FALSE, $group_description = '', $additional_data = array(), $group_deck = '') { //echo "hello";
        //print_r($group_deck);
        //die();
        ...
        $data = array('name' => $group_name, 'description' => $group_description, 'deck' => $group_deck);
     ...
     * @author aditya menon
     * */
    public function update_group($group_id = FALSE, $group_name = FALSE, $additional_data = array(), $group_deck = '') {
        //echo "hello";
        //print_r($group_deck);
        //die();
        if (empty($group_id))
    ...
    public function insert_import_file($import_data) {
        $return = FALSE;
        $insert_data = $this->db->insert('users', $import_data);
        if ($insert_data) {
            $return = TRUE;
        }
        return $return;
