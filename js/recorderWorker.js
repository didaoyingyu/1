...
this.onmessage = function(e){
  switch(e.data.command){
    ...
    case 'record':
      ...
      break;
    case 'exportWAV':
      exportWAV(e.data.type, e.data.obj, e.data.id, e.data.rectype);
      break;
    case 'getBuffer':
      getBuffer();
      break;
...
function exportWAV(type, obj, id, rectype){
  ...
  this.postMessage({audioBlob:audioBlob, id:id, rectype:rectype, obj:obj});
}
