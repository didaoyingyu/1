...
//			$msg = "Something went wrong when saving the file, please try again.";
    ...
    /*     * ******************Logic For deck Upload Excel File Starts************************* */
    ...
    public function save_import_file() {
        if ($this->input->post("attachment")) {
            ...
            $excel_data['field'] = array('question', 'question_note', 'answer', 'answer_note', 'question_upload_file', 'question_upload_file_slow', 'answer_upload_file', 'answer_upload_file_slow');
            ...
            if ($import_data && $import_data != "invalid") {
                foreach ($import_data as $data) {
                    $data['created_user_id'] = $this->ion_auth->get_user_id();
                    $card_id = $this->card->insert_import_file($data,$deck_id);
                }
                if ($card_id) {
    ...
    /*     * ******************Logic For deck Upload Excel File Ends************************* */
}
